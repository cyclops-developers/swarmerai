...
export const BACKEND_JOB_TASK_COMPLETED_FIELD_NAME = 'taskCompleted';
export const BACKEND_JOB_EXPECTED_SUBMISSIONS_FIELD_NAME = 'expectedSubmissions';
...
export class Job {
  ...
  getProgress = () => 0.2
  getTaskCompleted = () =>
    this.content[BACKEND_JOB_TASK_COMPLETED_FIELD_NAME] || 0
  getExpectedSubmissions = () =>
    this.content[BACKEND_JOB_EXPECTED_SUBMISSIONS_FIELD_NAME] || 0
}
